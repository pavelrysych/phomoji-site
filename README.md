...
On branch `experiment/lamp-react`, the repo includes a **Next.js + TypeScript + Tailwind + shadcn** sub-app in `lamp-ui/` (Lamp / framer-motion demo at `/lamp`). It does not replace the static landing; deploy or run it separately — see `lamp-ui/README.md`.
